...
const BlogInteraction =()=> {
    ...
    let { blog, blog: { _id, title, blog_id, activity, activity: { total_likes, total_comments }, author: { personal_info: { username: author_username } } }, setBlog, islikeByUser, setLikedByUser} = useContext(BlogContext);
